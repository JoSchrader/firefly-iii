...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    addTransactionToArray: function addTransactionToArray(e) {
      ...
      if (this.transactions.length > 1) {
        var i = this.transactions.length;
...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c("form", {
    staticClass: "form-horizontal transactions-form",
    attrs: {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.jonasSimplify,
      expression: "jonasSimplify"
    }],
    staticStyle: {
      cursor: "pointer"
    },
    ...
    domProps: {
      checked: Array.isArray(_vm.jonasSimplify) ? _vm._i(_vm.jonasSimplify, null) > -1 : _vm.jonasSimplify
    },
    on: {
      change: function change($event) {
        var $$a = _vm.jonasSimplify,
          $$el = $event.target,
        ...
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$el.checked) {
            $$i < 0 && (_vm.jonasSimplify = $$a.concat([$$v]));
          } else {
            $$i > -1 && (_vm.jonasSimplify = $$a.slice(0, $$i).concat($$a.slice($$i + 1)));
          }
        } else {
          _vm.jonasSimplify = $$c;
        }
  ...
  }, [_vm._v("Vereinfachen")])]), _vm._v(" "), _c("input", {
    attrs: {
      name: "_token",
      type: "hidden",
      value: "xxx"
    ...
    staticClass: "row",
    style: {
      opacity: _vm.transactions.length > 1 ? 1 : 0.65
    }
  }, [_c("div", {
  ...
  })], 1)])])]), _vm._v(" "), _vm.error_message !== "" ? _c("div", {
    staticClass: "row"
  }, [_c("div", {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "fa fa-trash-o"
  })])])]), _vm._v(" "),  false ? 0 : _vm._e(), _vm._v(" "), _vm._l(this.error, function (error) {
    return _c("ul", {
      staticClass: "list-unstyled"
    }, [_c("li", {
      staticClass: "text-danger"
